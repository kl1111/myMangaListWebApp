	...
	<div class="container-fluid text-center">
		...
		<!--This is the main body, center-->
			<div class="col-sm-8 central">
				...
				<div>
					<sf:form action="../submitUpdateReview" method="POST" modelAttribute="review">
						<sf:label path="rating">New rating: </sf:label>
						<sf:select items="${ratingList}" path="rating" />
						<sf:label path="reviewContent">New review:</sf:label>
